...
import { KiroAIService } from "../AIService";
...
describe("KiroAIService", () => {
  ...
  describe("Availability Check", () => {
    ...
    it("should return false when initialization fails", async () => {
      ...
      vi.spyOn(aiService as any, "detectCurrentModel").mockRejectedValue(
  ...
  describe("Error Handling", () => {
    ...
    it("should throw AIError when service is unavailable", async () => {
    ...
    it("should handle rate limit errors", async () => {
      ...
      vi.spyOn(aiService as any, "callKiroAI").mockRejectedValue(
  ...
  describe("Commit Prompt Creation", () => {
    it("should create specific commit prompt", () => {
      const prompt = aiService.createCommitPrompt(
        mockDiff,
        CommitType.FEAT,
        "components"
      );
    ...
    it("should include file details in prompt", () => {
      ...
      expect(prompt).toContain(
        "src/components/__tests__/Button.test.tsx (added)"
      );
  ...
  describe("Mock Response Generation", () => {
    it("should generate test-related responses", () => {
      const generateMockResponse = (aiService as any).generateMockResponse.bind(
        aiService
      );
  ...
  describe("Error Classes", () => {
    it("should create AIError with code", () => {
    ...
    it("should allow custom messages for error classes", () => {
      const unavailableError = new AIError(
      ...
      const invalidResponseError = new AIError(
        "Custom invalid response message",
        "INVALID_RESPONSE"
      );
      ...
      expect(invalidResponseError.message).toBe(
        "Custom invalid response message"
      );
    });
  });
